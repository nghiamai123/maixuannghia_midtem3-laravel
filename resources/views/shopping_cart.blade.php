	...
	<div id="content">
				...
				<tbody>
					...
					<tr class="cart_item">
						<td class="product-name">
							<div class="media">
								...
								<div class="media-body">
									...
									<a class="table-edit" href="{{ route('formEdit', ['id' => $product['item']['id']]) }}">Edit</a>
								</div>
							</div>
						</td>

						<td class="product-price">
							<span class="amount">{{ number_format($product['item']['promotion_price']) }}</span>
						</td>
						...
						<td class="product-subtotal">
							<span class="amount">{{ number_format($product['item']['promotion_price'] * $product['qty']) }}</span>
						</td>
		...
		<div class="cart-collaterals">
			...
			<div class="cart-totals pull-right">
				...
				<div class="cart-totals-row"><span>Cart Subtotal:</span> <span>{{ $totalQty }}</span></div>
				<div class="cart-totals-row"><span>Shipping:</span> <span>Free Shipping</span></div>
				<div class="cart-totals-row"><span>Order Total:</span> <span>{{$totalPrice}}</span></div>
			</div>
